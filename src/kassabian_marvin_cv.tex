...
\resumesublistbegin
    \item Contracted to architect and deliver MVP for enterprise-scale HR performance-tracking platform from inception to go-live, building full-stack application with Vue.js 3/TypeScript frontend and Go backend.
    ...
    \item Implemented comprehensive test suite with 100+ test functions following TDD principles, ensuring code reliability and maintainability across full-stack development.
    \item Deployed containerized application using Docker and Kubernetes with GitLab CI/CD pipelines, managing multi-environment deployments with OpenTelemetry observability for distributed tracing.
\resumesublistend
...
\resumesublistbegin
    ...
    \item Developed educational platform frontend using Next.js, enabling teachers to create, schedule, and publish lessons with integrated questions, utilizing PayloadCMS and Firebase.
