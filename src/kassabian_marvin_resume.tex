...
\resumesublistbegin
    ...
    \item \textbf{Frameworks and Libraries:} Next.js, Vue.js, scikit-learn
...
\resumesublistbegin
    ...
    \item Created a Go-based API to streamline accounts payable integration between Medius and Microsoft Dynamics GP.
...
\resumesublistbegin
    ...
    \item Designed and implemented backend systems for government integration in ASP.NET Core.
